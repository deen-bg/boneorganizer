...
<head>
	...
	<title>Edit Banner Service  | SJT PICO </title>
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">บริการสินเชื่อ > แก้ไขแบนเนอร์</h3>
			            </div>
			            <div class="panel-body container-fluid">
			              	<form action="<?=base_url('Admin/update_bannerservice');?>" id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
								<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" > 
							  <div class="form-group form-material" data-plugin="formMaterial">
				                <label class="form-control-label" for="title">ชื่อ</label>
								<input type="text" class="form-control" id="name" name="name" value="<?=$banner_descs[0]['name']; ?>" required>
				                </div>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
									...
									<div id="width"></div>
									  ...
									  data-default-file="<?=base_url('./assets/images/banner/service/'. $banner_descs[0]['img_cover']);?>" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG"/>
									<p class="help-block"><i>
									รองรับไฟล์ภาพ <br>
									ขนาดภาพ 1961X497px <br> 
				                ...
				                <div class="text-right">
				                	<input type="hidden" name="bannerservice_id" value="<?=$banner_descs[0]['id']; ?>">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = '<?=base_url('Admin/banner_about');?>';">
