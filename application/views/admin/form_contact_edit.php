					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            ...
			            <div class="panel-body container-fluid">
			              	<form action="<?=base_url('Admin/update_contact');?>" id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
							  <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" >
				                <div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">Address</label>
				                  	<input type="text" class="form-control" id="c_add" name="c_add" value="<?=$contact_dscs[0]['c_add']; ?>" autocomplete="off" >
				                </div>
								<div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">Tel.</label>
				                  	<input type="tel" class="form-control" id="c_tel" name="c_tel" value="<?=$contact_dscs[0]['c_tel']; ?>" autocomplete="off" placeholder="" >
				                </div>
								<div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">Line ID</label>
				                  	<input type="text" class="form-control" id="c_line_id" name="c_line_id" value="<?=$contact_dscs[0]['c_line_id']; ?>" autocomplete="off" >
				                </div>
								<div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">Facebook</label>
				                  	<input type="text" class="form-control" id="c_fb" name="c_fb" value="<?=$contact_dscs[0]['c_fb']; ?>" autocomplete="off" >
				                </div>
								<div class="form-group form-material" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="title">Email</label>
				                  	<input type="email" class="form-control" id="c_mail" name="c_mail" value="<?=$contact_dscs[0]['c_mail']; ?>" autocomplete="off" >
				                </div>
				                <div class="text-right">
				                	<input type="hidden" name="c_id" value="<?=$contact_dscs[0]['id']; ?>">
