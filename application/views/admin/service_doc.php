		...
		<div class="page-content container-fluid">
	      	...
	      	<div class="panel">
		        <div class="panel-heading">
		          	<h3 class="panel-title"><?=$service_docs[0]['name'];?></h3>
		        </div>
			                  		...
			                  		<div class="fixed-table-toolbar">
									  	<div class="bs-bars pull-left">
			                  				<div class="btn-group hidden-sm-down" id="exampleToolbar" role="group">
							                    <button type="button" class="btn btn-success btn-outline btn-sm" onclick="window.location.href = '<?=base_url('Admin/form_service_upload/'.$service_docs[0]['id'].'/?slug='.$service_docs[0]['name']);?>';">
			                  		...
			                  		<div class="" style="padding-bottom: 0px;">
			                  			<div class="fixed-table-body">
			                  				<table id="exampleTableToolbar" data-mobile-responsive="true" class="table table-hover" data-pagination="true" data-search="true" style="margin-top: 0px;">
			                    				...
			                    				<?php if(!empty($service_file)) : ?>
			                  					<tbody>
			                  						<?php 
													$i = 0;
													foreach($service_file as $val_item) : 
													?>
			                  						<tr> 
			                  							<td class=""><?=$i+1; ?></td> 
			                  							<td style=""><?=$val_item['img_name']; ?></td>
														<td style=""><?=$val_item['title']; ?></td>
														<td>
														...
														<td style="">
															<img src="<?=base_url('assets/images/service/'.$this->uri->segment(3).'/'.$val_item['img_name']);?>" class="img-fluid img-thumbnail" alt="<?=$val_item['title']; ?>" style="width: 20%;">
														</td>
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel2">Edit title</h4>
				</div>
	...
	<script type="text/javascript">
		...
		function addTitle()
		{
			$.ajax({
				...
				data 	: {id:$('#serv_id').val(),title:$('#img_title').val(), action:'addTitle', '<?=$this->security->get_csrf_token_name(); ?>':'<?=$this->security->get_csrf_hash(); ?>'},
