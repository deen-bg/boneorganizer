...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" type="image/ico" sizes="114×114" href="<?=base_url('./assets/img/logo/favicon.ico');?>">
    <link rel="apple-touch-icon-precomposed" type="image/ico" sizes="72×72" href="<?=base_url('./assets/img/logo/favicon.ico');?>">
...
<body class="animsition page-login layout-full page-dark" style="animation-duration: 800ms; opacity: 1;">
	<div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
		<div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
			<div class="brand">
				<img class="brand-img" src="<?=base_url('assets/img/logo/B ONE.png');?>">
				<h2 class="brand-text">B ONE</h2>
			</div>
